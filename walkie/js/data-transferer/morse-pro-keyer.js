...
var MorseKeyer = function () {
  ...
  function MorseKeyer(keyCallback) {
    ...
    var frequency = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 550;
    ...
    this.decoder = new _morseProDecoder2.default(this.wpm);
